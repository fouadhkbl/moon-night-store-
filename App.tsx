...
const LoginForm = ({ onAuthSuccess, onToggle }: { onAuthSuccess: (s: any) => void, onToggle: () => void }) => {
  ...
  return (
    <div className="bg-[#1e232e] p-10 rounded-[2rem] border border-gray-800 shadow-2xl animate-fade-in max-w-md mx-auto">
      ...
      <button onClick={onToggle} className="w-full text-center mt-8 text-[10px] text-gray-500 hover:text-blue-400 transition font-black uppercase tracking-[0.2em]">New to the system? Create Profile</button>
    </div>
  );
};
