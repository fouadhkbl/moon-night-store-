    ...
    <div className="bg-[#1e232e] p-10 rounded-[2rem] border border-gray-800 shadow-2xl animate-fade-in max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <button 
            ...
            disabled={loading} 
            className="bg-white hover:bg-gray-100 text-black font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-2 uppercase tracking-widest shadow-xl group active:scale-95 text-[10px]"
        >
        ...
        <button 
            ...
            disabled={loading} 
            className="bg-[#5865F2] hover:bg-[#4752c4] text-white font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-2 uppercase tracking-widest shadow-xl group active:scale-95 text-[10px]"
        >
