...
import { ChevronRight, ChevronLeft, Star, Coins, Key, Sword, ArrowUpCircle, Gift, Users, Trophy, Swords, Calendar, Crown, TrendingUp, Sparkles, ShoppingCart } from 'lucide-react';
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <button 
                ...
                className="h-[50px] md:h-[60px] bg-blue-600 hover:bg-blue-700 text-white px-8 md:px-10 rounded-xl font-black text-xs md:text-sm transition-all flex items-center gap-3 uppercase tracking-widest shadow-[0_0_30px_rgba(37,99,235,0.4)] group hover:scale-105 active:scale-95"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {trendingProducts.map(product => (
                      <div 
                        ...
                        className="bg-[#1e232e] rounded-3xl border border-gray-800 overflow-hidden cursor-pointer group hover:border-red-500/50 transition-all shadow-xl"
                      >
                          ...
                          <div className="p-5">
                              ...
                              <div className="flex justify-between items-center">
                                  ...
                                  <div className="w-8 h-8 bg-[#0b0e14] rounded-full flex items-center justify-center text-white group-hover:bg-red-600 transition-colors">
