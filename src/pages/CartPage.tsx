    ...
    <div className="container mx-auto px-4 py-8 md:py-12 animate-fade-in max-w-6xl pb-32 md:pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="hidden lg:block bg-[#1e232e] rounded-[2rem] border border-gray-800 p-8 shadow-2xl sticky top-24">
          <h2 className="text-xl font-black text-white italic mb-6 border-b border-gray-800 pb-4 uppercase tracking-tighter">Summary</h2>
          ...
          <p className="text-center text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-6">
             Coupons & Payment in Next Step
          </p>
        </div>
      </div>

      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#1e232e]/95 backdrop-blur-lg border-t border-gray-800 p-4 px-6 flex items-center justify-between gap-4 shadow-2xl">
         <div>
